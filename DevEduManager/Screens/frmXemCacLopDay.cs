...
namespace DevEduManager.Screens
{
    public partial class frmXemCacLopDay : Form
    {
        ...
        public frmXemCacLopDay(Panel mainPanel, string teacherId)
        {
            InitializeComponent();
            _teacherId = teacherId;
            _mainPanel = mainPanel;
            Load += frmThongTinGiangVien_Load;
            gridLop.CellPainting += gridLop_CellPainting;
        }

        private async void frmThongTinGiangVien_Load(object sender, EventArgs e)
        {
            // Setup columns
